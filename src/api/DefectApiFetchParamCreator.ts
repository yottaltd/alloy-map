...
/**
 * DefectApi - fetch parameter creator
 * @export
 */
export const DefectApiFetchParamCreator = function (configuration?: Configuration) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    defectListApplicableDefectDesigns(itemDesignsModel: ItemDesignsForFilterWebRequestModel, page?: number, pageSize?: number, options: any = {}): FetchArgs {
