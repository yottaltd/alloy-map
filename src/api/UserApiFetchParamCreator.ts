...
export const UserApiFetchParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    userCreate(model: AlloyUserCreateWebRequestModel, options: any = {}): FetchArgs {
      ...
      const needsSerialization = (<any>"AlloyUserCreateWebRequestModel" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
     ...
     * @throws {RequiredError}
     */
    userEditCurrentUser(model: AlloyUserEditCurrentWebRequestModel, options: any = {}): FetchArgs {
      // verify required parameter 'model' is not null or undefined
      if (model === null || model === undefined) {
        throw new RequiredError('model','Required parameter model was null or undefined when calling userEditCurrentUser.');
      }
      ...
      delete localVarUrlObj.search;
      localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
      const needsSerialization = (<any>"AlloyUserEditCurrentWebRequestModel" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
      localVarRequestOptions.body =  needsSerialization ? JSON.stringify(model || {}) : (model || "");
     ...
     * @throws {RequiredError}
     */
    userForgotPasswordReset(model: ForgotPasswordWebRequestModel, options: any = {}): FetchArgs {
      // verify required parameter 'model' is not null or undefined
      if (model === null || model === undefined) {
        throw new RequiredError('model','Required parameter model was null or undefined when calling userForgotPasswordReset.');
      }
      ...
      delete localVarUrlObj.search;
      localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
      const needsSerialization = (<any>"ForgotPasswordWebRequestModel" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
      localVarRequestOptions.body =  needsSerialization ? JSON.stringify(model || {}) : (model || "");
     ...
     * @throws {RequiredError}
     */
    userRemove(username: string, options: any = {}): FetchArgs {
      // verify required parameter 'username' is not null or undefined
      if (username === null || username === undefined) {
        throw new RequiredError('username','Required parameter username was null or undefined when calling userRemove.');
      }
      const localVarPath = `/api/user/{username}`
        .replace(`{${"username"}}`, encodeURIComponent(String(username)));
      const localVarUrlObj = url.parse(localVarPath, true);
     ...
     * @throws {RequiredError}
     */
    userRequestPasswordReset(options: any = {}): FetchArgs {
      const localVarPath = `/api/user/request-password-reset`;
      const localVarUrlObj = url.parse(localVarPath, true);
      const localVarRequestOptions = Object.assign({ method: 'POST' }, options);
      const localVarHeaderParameter = {} as any;
      const localVarQueryParameter = {} as any;
     ...
     * @throws {RequiredError}
     */
    userSubmitPasswordReset(resetToken: string, model: SubmitPasswordResetWebRequestModel, options: any = {}): FetchArgs {
      // verify required parameter 'resetToken' is not null or undefined
      if (resetToken === null || resetToken === undefined) {
        throw new RequiredError('resetToken','Required parameter resetToken was null or undefined when calling userSubmitPasswordReset.');
      }
      // verify required parameter 'model' is not null or undefined
      if (model === null || model === undefined) {
        throw new RequiredError('model','Required parameter model was null or undefined when calling userSubmitPasswordReset.');
      }
      const localVarPath = `/api/user/password-reset/{resetToken}`
      ...
      delete localVarUrlObj.search;
      localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
      const needsSerialization = (<any>"SubmitPasswordResetWebRequestModel" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
      localVarRequestOptions.body =  needsSerialization ? JSON.stringify(model || {}) : (model || "");
