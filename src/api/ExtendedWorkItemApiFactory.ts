...
export const ExtendedWorkItemApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
  return {
    ...
    workItemListApplicableComponentWorkItems(code: string, page?: number, pageSize?: number, options?: any) {
      return ExtendedWorkItemApiFp(configuration).workItemListApplicableComponentWorkItems(code, page, pageSize, options)(fetch, basePath);
    },
    /**
    ...
    workItemListApplicableWorkItems(code: string, page?: number, pageSize?: number, options?: any) {
      return ExtendedWorkItemApiFp(configuration).workItemListApplicableWorkItems(code, page, pageSize, options)(fetch, basePath);
    },
    /**
