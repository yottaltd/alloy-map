 ...
 * 
 * @export
 * @interface CustomReportControlPropertyWebModelOfString
 */
export interface CustomReportControlPropertyWebModelOfString {
  /**
   * 
   * @type {string}
   * @memberof CustomReportControlPropertyWebModelOfString
   */
