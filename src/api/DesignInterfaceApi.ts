...
export class DesignInterfaceApi extends BaseAPI {
   ...
   * @memberof DesignInterfaceApi
   */
  public designInterfaceGetPermissions(code: string, options?: any) {
    return DesignInterfaceApiFp(this.configuration).designInterfaceGetPermissions(code, options)(this.fetch, this.basePath);
  }
   ...
   * @memberof DesignInterfaceApi
   */
  public designInterfaceList(query?: string, implementedByDodi?: string, implementsInterface?: string, userGroup?: string, childDodi?: string, page?: number, pageSize?: number, options?: any) {
    return DesignInterfaceApiFp(this.configuration).designInterfaceList(query, implementedByDodi, implementsInterface, userGroup, childDodi, page, pageSize, options)(this.fetch, this.basePath);
  }
