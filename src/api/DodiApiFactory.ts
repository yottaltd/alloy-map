...
export const DodiApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
  return {
     ...
     * @throws {RequiredError}
     */
    dodiList(query?: string, implementsInterface?: string, userGroup?: string, childDodi?: string, page?: number, pageSize?: number, options?: any) {
      return DodiApiFp(configuration).dodiList(query, implementsInterface, userGroup, childDodi, page, pageSize, options)(fetch, basePath);
    },
  };
};
