...
export class WorkflowActionGroupApi extends BaseAPI {
   ...
   * @memberof WorkflowActionGroupApi
   */
  public workflowActionGroupGetPermissions(code: string, username?: string, options?: any) {
    return WorkflowActionGroupApiFp(this.configuration).workflowActionGroupGetPermissions(code, username, options)(this.fetch, this.basePath);
  }
   ...
   * @memberof WorkflowActionGroupApi
   */
  public workflowActionGroupList(name?: string, userGroup?: string, actionGroupInputCode?: string, page?: number, pageSize?: number, options?: any) {
    return WorkflowActionGroupApiFp(this.configuration).workflowActionGroupList(name, userGroup, actionGroupInputCode, page, pageSize, options)(this.fetch, this.basePath);
  }
   ...
   * @memberof WorkflowActionGroupApi
   */
  public workflowActionGroupWorkflowActionGroupAccessAdvisor(username: string, page?: number, pageSize?: number, options?: any) {
    return WorkflowActionGroupApiFp(this.configuration).workflowActionGroupWorkflowActionGroupAccessAdvisor(username, page, pageSize, options)(this.fetch, this.basePath);
  }
