...
export const DesignInterfaceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
  return {
     ...
     * @throws {RequiredError}
     */
    designInterfaceEditPermissions(code: string, model: DodiPermissionsEditWebRequestModel, options?: any) {
      return DesignInterfaceApiFp(configuration).designInterfaceEditPermissions(code, model, options)(fetch, basePath);
    },
    /**
