...
/**
 * ExtendedJobWorkItemApi - fetch parameter creator
 * @export
 */
export const ExtendedJobWorkItemApiFetchParamCreator = function (configuration?: Configuration) {
  return {
    /**
     ...
     */
    jobWorkItemClone(id: string, model: ExtendedCloneWebRequestModel, options: any = {}): FetchArgs {
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError('id','Required parameter id was null or undefined when calling jobWorkItemClone.');
      }
      // verify required parameter 'model' is not null or undefined
      if (model === null || model === undefined) {
        throw new RequiredError('model','Required parameter model was null or undefined when calling jobWorkItemClone.');
      }
      const localVarPath = `/api/job-work-item/{id}/clone`
