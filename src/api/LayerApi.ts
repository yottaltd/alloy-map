...
export class LayerApi extends BaseAPI {
   ...
   * @memberof LayerApi
   */
  public layerGetHeatmapLayerTile(code: string, x: number, y: number, z: number, styleIds?: Array<string>, options?: any) {
    return LayerApiFp(this.configuration).layerGetHeatmapLayerTile(code, x, y, z, styleIds, options)(this.fetch, this.basePath);
  }
