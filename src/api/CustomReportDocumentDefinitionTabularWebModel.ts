 ...
 * 
 * @export
 * @interface CustomReportDocumentDefinitionTabularWebModel
 */
export interface CustomReportDocumentDefinitionTabularWebModel extends CustomReportDocumentDefinitionWebModelBase {
  /**
   ...
   * @memberof CustomReportDocumentDefinitionTabularWebModel
   */
