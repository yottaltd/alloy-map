 ...
 * @internal
 */
export class AlloyCableStyleBuilder extends AlloyStyleBuilder<AlloyCustomFeature> {
  /**
  ...
  protected createStyles(feature: AlloyCustomFeature, resolution: number): OLStyle | OLStyle[] {
    switch (feature.olFeature.getGeometry().getType()) {
      ...
      default:
        throw new AlloyMapError(1559153404, 'unsupported geometry type');
    }
  }
  ...
  protected createHoverStyles(
    ...
    switch (feature.olFeature.getGeometry().getType()) {
      ...
      default:
        throw new AlloyMapError(1559153412, 'unsupported geometry type');
    }
  }
  ...
  protected createSelectedStyles(
    ...
    switch (feature.olFeature.getGeometry().getType()) {
      ...
      default:
        throw new AlloyMapError(1559153420, 'unsupported geometry type');
    }
  }
  ...
  private createIconStyle(
    ...
    if (feature.properties.icon) {
      ...
      throw new AlloyMapError(1559153427, 'Cable feed style requires an icon or text');
    }
  }
