...
import { AlloyBasicFeatureProperties } from './AlloyBasicFeatureProperties';
 ...
 */
export class AlloyBasicFeature implements AlloyFeature, AlloyFeatureWithItemId {
  /**
   * @implements
   */
   ...
   */
  public readonly properties: Readonly<AlloyBasicFeatureProperties>;
  ...
  constructor(
    id: string,
    olFeature: OLFeature,
    properties: AlloyBasicFeatureProperties,
 ...
 */
AlloyBasicFeature.prototype.type = AlloyFeatureType.Item;
AlloyBasicFeature.prototype.allowsSelection = true;
AlloyBasicFeature.prototype.allowsHover = true;
