...
import { AlloyWfsHeatmapFeatureProperties } from './AlloyWfsHeatmapFeatureProperties';

/**
 * an alloy wfs feature
 */
export class AlloyWfsHeatmapFeature implements AlloyFeature {
  /**
   * @implements
   */
  public type!: AlloyFeatureType.WfsHeatmap; // see end of file for prototype
   ...
   */
  public readonly properties: Readonly<AlloyWfsHeatmapFeatureProperties>;
  ...
  public constructor(
    id: string,
    olFeature: OLFeature,
    properties: AlloyWfsHeatmapFeatureProperties,
 ...
 */
AlloyWfsHeatmapFeature.prototype.type = AlloyFeatureType.WfsHeatmap;
AlloyWfsHeatmapFeature.prototype.allowsSelection = false;
AlloyWfsHeatmapFeature.prototype.allowsHover = false;
